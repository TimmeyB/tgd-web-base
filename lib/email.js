...
export async function sendVerificationEmail(to, verifyUrl) {
  return send({
    to,
    subject: 'Confirm your TaskGrind email',
    text: `Hey,

Thanks for signing up for TaskGrind. Click the link below to confirm this is your email address:

${verifyUrl}

This link works for 24 hours. If you didn't sign up for TaskGrind, you can ignore this email — no account gets confirmed unless you click the link.
