...
export async function POST(request) {
  ...
  const { campaignId, testerHandle, status, screeningAnswers, proofText, proofUrl } = await request.json();
  ...
  if (existing) {
    ...
    const insertResult = await query(
      `INSERT INTO submissions (campaign_id, tester_handle, status, screening_answers, proof_text, proof_url, reviewed_at, completed_at)
       VALUES ($1, $2, $3, $4, $5, $6,
